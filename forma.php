    ...
    <main role="main">
      ...
      <div class="container mt-4">
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-8"> 
            <form action="https://formspree.io/rbivbi.rehfuf@gmail.com" method="POST">
              ...
              <div class="form-group">
                ...
                <textarea id="text-area" cols="30" rows="10" name="text" required class="form-control"></textarea> 
              </div>                  
